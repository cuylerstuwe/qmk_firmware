...
[_LEFT_RAISE] = LAYOUT_preonic_grid(
    ENCODER_PRESS, _______,      _______,      _______,      _______,      _______,     _______,     _______,     _______,       _______,       _______,      _______,
    _______,       _______,      LGUI(KC_F17), LGUI(KC_F18), LGUI(KC_F19), _______,     _______,     LGUI(KC_F17), LGUI(KC_F18), LGUI(KC_F19), _______,      _______,
    _______,       _______,      LCA(KC_F17),  LCA(KC_F18),  LCA(KC_F19),  LSA(KC_F17), LSA(KC_F18), LCA(KC_F17), LCA(KC_F18),   LCA(KC_F19),   _______,      _______,
